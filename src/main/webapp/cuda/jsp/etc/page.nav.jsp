...
<nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
	<div class="position-sticky pt-3">
		<ul class="nav flex-column">
			<li class="nav-item">
			<a class="nav-link active" aria-current="page" href="<c:url value="/cuda/home.do"/>" id="id-menu-01"> 
			...
			<li class="nav-item">
			<a class="nav-link" href="<c:url value="/ksl/wordList.do"/>" id="id-menu-02"> 
				...
				<polyline points="13 2 13 9 20 9"></polyline></svg> 수어단어
			</a>
			</li>
			<li class="nav-item">
			<a class="nav-link" href="<c:url value="/ksl/sumryList.do?category=daily"/>"  id="id-menu-03"> 
			...
			<li class="nav-item">
			<a class="nav-link" href="<c:url value="/ksl/categoryList.do"/>"  id="id-menu-04"> 
			...
			<li class="nav-item">
			<a class="nav-link" href="<c:url value="/ksl/logList.do"/>"  id="id-menu-05">
			...
			<li class="nav-item">
			<a class="nav-link" href="<c:url value="/ksl/userList.do"/>"  id="id-menu-06"> 
			<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-layers" aria-hidden="true">
									...
									<polyline points="2 12 12 17 22 12"></polyline></svg> 사용자
			</a></li>
			<li class="nav-item">
			<a class="nav-link" href="<c:url value="/ksl/etriList.do"/>"  id="id-menu-07"> 
...
<!-- 			<li class="nav-item"><a class="nav-link" href="#"> <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-file-text" aria-hidden="true"> -->
