                        ...
                        <div id="panel4" class="main__contents--eduProgramArea main__contents--wood" role="tabpanel" tabindex="0" aria-labelledby="tab4" hidden>
                            ...
                            <div class="main__contents--eduProgramContents">
                                ...
                                <div class="main__contents--eduProgramContentsPhoto">
                                    <img src="<c:url value="/forest/assets/images/6c626d0b7f5ab8a472644126cd617b3011291bc7.png"/>" alt="목재문화체험장 건물 외관 1" class="wood-buildingPhoto">
                                    <img src="<c:url value="/forest/assets/images/c12ddea9e19e4702ca8a101679d330230f3827a7.png"/>" alt="목재문화체험장 내부 모습 2" class="wood-buildingPhoto">
                                    <img src="<c:url value="/forest/assets/images/c89377560650b16c653297fac67b6727838a5c64.png"/>" alt="목재문화체험장 작업실 모습 3" class="wood-buildingPhoto">
                                </div>
                                <div class="main__contents--eduProgramInfoArea">
                        ...
                        <div id="panel6" class="main__contents--eduProgramArea main__contents--infant" role="tabpanel" tabindex="0" aria-labelledby="tab6" hidden>
                            ...
                            <div class="main__contents--eduProgramContents">
                                ...
                                <ul>
                                    ...
                                    <li>
                                        <p>'유아숲체험원'의 법적 정의에는 '시설'이라는 표현을 쓰고 있지만 그 본질은 시설보다는 공간의 의미가 더 큽니다.<br>(물론 유아숲체험원에는 대피소 등 시설물도 포함되지만 '야외체험학습장' 같이 공간의 비중이 큰 것을 의미합니다.)</p>
                                    </li>
                                </ul>
                                <div class="main__contents--eduProgramInfoArea">
                                    <div class="main__contents--eduProgramInfo">
