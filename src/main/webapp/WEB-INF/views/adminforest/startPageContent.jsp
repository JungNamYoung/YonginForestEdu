		...
		<div class="card d-none">
			<div class="card-body">
				<form method="post" action="<c:url value='/admin/start-page'/>">
					...
					<div class="form-check">
						<input class="form-check-input" type="radio" name="page" id="pageEvent" value="/forest/portrait" ${startPage == '/forest/portrait' ? 'checked' : ''}> 
				...
				<div class="row">
					<c:forEach var="fileVo" items="${listFileVo}">
						<div class="col-md-3 text-center mb-4">
							...
							<form method="post" action="<c:url value='/admin/landscape/delete'/>" class="mt-2">
