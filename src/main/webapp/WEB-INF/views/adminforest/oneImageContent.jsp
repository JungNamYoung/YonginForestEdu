...
<section class="content">
	<div class="container-fluid">
		<div class="card mb-3">
			<div class="card-body">
				<form method="post" action="<c:url value='/admin/one-image/upload'/>" enctype="multipart/form-data">
		...
		<div class="row">
			<c:forEach var="img" items="${listFileVo}">
				<div class="col-md-3 text-center mb-4">
					...
					<form method="post" action="<c:url value='/admin/one-image/delete'/>" class="mt-2">
